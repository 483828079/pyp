...
import com.pinyougou.common.PasswordUtils;
...
public class SellerServiceImpl implements SellerService {
	...
	public void add(TbSeller seller) {
		// 添加商户的时候对其密码进行加密
		seller.setPassword(PasswordUtils.passwordEncoder(seller.getPassword()));
	...
	public void delete(String[] ids) {
		...
		criteria.andSellerIdIn(Arrays.asList(ids));
